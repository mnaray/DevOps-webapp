...
| 6.1             | 6             | Tests werden ausgeführt         | Actions, Vite, ESLint, Prettier, Playwright, Snyk | PR in main, Tests erfoglgen,             | Pipeline erstellt Build.                       |
...
| 8               | 8             |                                  | Playwright, Vite                                  | PR in main                              | Test für diese Anforderung failed oder nicht.  |
| 9               | 9             | -                                | Playwright, Vite                                  | PR in main                              | Test für diese Anforderung failed oder nicht.  |
| 10              | 10            | -                                | Playwright, Vite                                  | PR in main                              | Test für diese Anforderung failed oder nicht.  |
| 11              | 11            | -                                | Playwright                                        | PR in main                              | Test für diese Anforderung failed oder nicht.  |
